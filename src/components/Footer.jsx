            ...
            <div className='flex'>
                ...
                {/* <div className='flex-1'>
                    ...
                    <div className='flex justify-between -space-x-3.5 '>
                        <input type="email" className='w-full rounded-lg p-2 bg-gray-900 text-white border border-transparent focus:outline-none focus:border-teal-400'
                            placeholder='Enter your Email' />
                        <button type="submit" className="bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-600 transition" href="#Contact">Subsucribe</button>
                    </div>
                 </form>
                </div> */}
                 <div className="flex-1">
