...
function Contact() {
    return (
        ...
        <div className='bg-black text-white px-2 py-20 lg:px-20 ' id='Contact'>
                ...
                <div className='flex flex-col md:flex-row item-center md:space-x-12 '>
                    ...
                    <div className='flex-1 space-x-3 pt-8'>
                        <div>
                            ...
                            <input type="text" className='w-full rounded-lg p-2 bg-gray-900 text-white  border border-transparent focus:outline-none focus:border-teal-400' placeholder='Enter your Name' />
                        </div>

                        <div>
                            <label htmlFor="email">Email</label>
                            <input type="email" className='w-full rounded-lg p-2 bg-gray-900 text-white  border border-transparent focus:outline-none focus:border-teal-400' placeholder='Enter your Email' />
                        </div>
                        <div>
                            <label htmlFor="messege">Messege</label>
                            <textarea type="messege" className='w-full rounded-lg p-2 bg-gray-900 text-white  border border-transparent focus:outline-none focus:border-teal-400' placeholder='Enter your Messege' rows={3}/>
                        </div>
                        <button className='bg-teal-900  rounded-lg hover:bg-amber-400 px-6 font-semibold py-2' >Send</button>
